    ...
    <div className="min-h-screen bg-hero-gradient pt-32 px-4 text-center">
      ...
      <div className="container mx-auto max-w-2xl animate-fade-in">
        ...
        <div className="font-amiri text-cream/80 text-xl max-w-lg mx-auto space-y-4">
          ...
          <p>
            هذا الموقع تم تطويره ليكون رفيقًا للمسلمين في شهر رمضان المبارك،
            يجمع أدعية مختارة لكل يوم من أيام الشهر الفضيل،
            بالإضافة إلى أدعية مصنفة حسب النية.
          </p>

          <p>
            نسأل الله أن يتقبل منا ومنكم صالح الأعمال،
            وأن يجعل هذا العمل صدقة جارية.
          </p>

          {/* صدقة جارية */}
          <p className="mt-6 text-gold text-xl leading-relaxed">
            اللهم اجعل هذا العمل صدقةً جاريةً عن أبي وأمي،  
            واغفر لي ولوالديَّ  
            وارحمهما كما ربياني صغيرًا.
          </p>

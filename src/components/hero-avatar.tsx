...
const HeroAvatar = ({ isSpeaking = false, size = 320 }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M62 88Q75 85 88 87" stroke="#3e2723" strokeWidth="2.5" strokeLinecap="round" opacity="0.7" />
        <path d="M112 87Q125 85 138 88" stroke="#3e2723" strokeWidth="2.5" strokeLinecap="round" opacity="0.7" />
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="flex flex-col items-center justify-center animate-slideRight">
            <HeroAvatar isSpeaking={isTyping} size={300} />
            
            <div className="mt-6 text-center">
              <p className="text-amber-50/60 text-sm italic">
                {isTyping ? '✍️ تكتب دعاءً...' : '🤲 في انتظار دعائك'}
              </p>
            </div>
          </div>
              ...
              <div className="space-y-6" dir="rtl">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="اللهم..."
                    className="w-full px-5 py-4 bg-blue-950/50 border border-yellow-600/20 rounded-2xl text-amber-50 placeholder:text-amber-50/30 focus:outline-none focus:border-yellow-600/50 focus:ring-2 focus:ring-yellow-600/20 transition-all min-h-[200px] font-serif text-xl leading-loose resize-none"
                    maxLength={500}
                  />
                ...
                <p className="text-amber-50/40 text-sm text-center">
